...
const SEEDED_POLICIES: SourceQualityPolicy[] = [
  ...
  {
    mediaKey: 'larepublica',
    source_tier: 'HIGH',
    source_mode: 'NEWS',
    allow_in_feed: true,
    single_source_allowed: true,
    ranking_multiplier: 1.0,
    notes: 'Major Colombian business/economy newspaper',
  },
  {
    mediaKey: 'cambio',
    source_tier: 'HIGH',
    ...
    single_source_allowed: true,
    ranking_multiplier: 1.0,
    notes: 'Colombian investigative news outlet',
  },
  {
    mediaKey: 'americas_quarterly',
    source_tier: 'HIGH',
    source_mode: 'ANALYSIS',
    allow_in_feed: true,
    single_source_allowed: true,
    ranking_multiplier: 0.9,
    notes: 'Latin America policy/analysis publication',
  },
  {
    mediaKey: 'pbs_newshour',
    source_tier: 'HIGH',
    source_mode: 'NEWS',
    allow_in_feed: true,
    single_source_allowed: true,
    ranking_multiplier: 1.0,
    notes: 'US public broadcasting news',
  },
  {
    mediaKey: 'carnegie',
    source_tier: 'HIGH',
    ...
    single_source_allowed: true,
    ranking_multiplier: 0.85,
    notes: 'International policy think tank',
  },
  {
    mediaKey: 'crisis_group',
    source_tier: 'HIGH',
    source_mode: 'ANALYSIS',
    allow_in_feed: true,
    single_source_allowed: true,
    ranking_multiplier: 0.85,
    notes: 'Conflict analysis / Latin America focus',
  },
];
